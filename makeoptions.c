...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/11/22 21:39:40 by abureau           #+#    #+#             */
/*   Updated: 2016/11/22 21:39:41 by abureau          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_fill(char *str, t_pf *print)
{
	int		i;
	int		tot;
...
static int	ft_hash_count(t_pf *print)
{
...
static int	ft_hash_apply(char *str, t_pf *print)
{
	if (print->type == 'O' || print->type == 'o')
	{
		str[0] = '0';
...
static int	ft_get_needed_len(t_pf *print)
{
	int		i;
